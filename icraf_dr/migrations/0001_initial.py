...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'icraf_dr_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cat_num', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('cat_alp', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('cat_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'icraf_dr', ['Category'])

        # Adding model 'Coverage'
        db.create_table(u'icraf_dr_coverage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cov_num', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('cov_alp', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('cov_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'icraf_dr', ['Coverage'])

        # Adding model 'Source'
        db.create_table(u'icraf_dr_source', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('src_num', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('src_alp', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('src_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'icraf_dr', ['Source'])

        # Adding model 'Year'
        db.create_table(u'icraf_dr_year', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('year_num', self.gf('django.db.models.fields.IntegerField')()),
            ('year_alp', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('year_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'icraf_dr', ['Year'])

        # Adding model 'Main'
        db.create_table(u'icraf_dr_main', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['icraf_dr.Category'])),
            ('coverage', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['icraf_dr.Coverage'])),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['icraf_dr.Source'])),
            ('year', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['icraf_dr.Year'])),
            ('basename', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('layer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['layers.Layer'], null=True)),
            ('topic_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.TopicCategory'], null=True)),
            ('regions', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('date_published', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('date_revised', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'icraf_dr', ['Main'])


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table(u'icraf_dr_category')

        # Deleting model 'Coverage'
        db.delete_table(u'icraf_dr_coverage')

        # Deleting model 'Source'
        db.delete_table(u'icraf_dr_source')

        # Deleting model 'Year'
        db.delete_table(u'icraf_dr_year')

        # Deleting model 'Main'
        db.delete_table(u'icraf_dr_main')
    ...
    models = {
        ...
        u'icraf_dr.category': {
            ...
            'cat_alp': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'cat_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'cat_num': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'icraf_dr.coverage': {
            'Meta': {'object_name': 'Coverage'},
            'cov_alp': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'cov_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'cov_num': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'icraf_dr.main': {
            'Meta': {'object_name': 'Main'},
            'basename': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['icraf_dr.Category']"}),
            'coverage': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['icraf_dr.Coverage']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_published': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'date_revised': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'layer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['layers.Layer']", 'null': 'True'}),
            'regions': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['icraf_dr.Source']"}),
            'topic_category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['base.TopicCategory']", 'null': 'True'}),
            'year': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['icraf_dr.Year']"})
        },
        u'icraf_dr.source': {
            'Meta': {'object_name': 'Source'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'src_alp': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'src_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'src_num': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'})
        },
        u'icraf_dr.year': {
            'Meta': {'object_name': 'Year'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'year_alp': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'year_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'year_num': ('django.db.models.fields.IntegerField', [], {})
        },
        u'layers.layer': {
